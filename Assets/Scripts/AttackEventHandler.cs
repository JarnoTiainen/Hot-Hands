...
public class AttackEventHandler : MonoBehaviour
{
    ...
    public void StartAttackEvent(bool wasYourAttack, CardPowersMessage attacker, CardPowersMessage target, float attackCD)
    {
        ...
        else
        {
            ...
            GameObject attackTarget = yourMonsterZone.GetCardWithServerIndex(target.index);
            ...
            attackingCard.GetComponent<CardMovement>().OnCardAttack(attackTarget, attackAnimationSpeed);
